...
<head>
    ...
    <link rel="stylesheet" href="adminform2styles.php">
    <title>Orders</title>
</head>
    ...
    <div class="container">
        ...
        <div class="d-flex">
            <form action="adminform2_process.php" method="POST">
                ...
                <label>
                    <span>&nbsp;</span>
                    <input type="text" name="houseadd" placeholder="Apartment, suite, unit etc. (optional)">
                </label>
                <label>
                ...
                <label>
                    ...
                    <input type="text" name="StateOrCounty">
                </label>
                <label>
                ...
                <div class="Yorder">
                    <table>
                        <tr>
                            <th colspan="2">Confirm User's Order</th>
                        </tr>
                        <tr>
